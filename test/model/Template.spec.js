...
(function(root, factory) {
  ...
  describe('Template', function() {
    ...
    it('should have the property htmlEngineOptions (base name: "html_engine_options")', function() {
      // uncomment below and update the code to test the property htmlEngineOptions
      //var instance = new DocSpring.Template();
      //expect(instance).to.be();
    });
    ...
    it('should have the property predefinedFields (base name: "predefined_fields")', function() {
      // uncomment below and update the code to test the property predefinedFields
      //var instance = new DocSpring.Template();
      //expect(instance).to.be();
    });
