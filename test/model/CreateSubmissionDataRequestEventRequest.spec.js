...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DocSpring.CreateSubmissionDataRequestEventRequest();
  });
  ...
  describe('CreateSubmissionDataRequestEventRequest', function() {
    it('should create an instance of CreateSubmissionDataRequestEventRequest', function() {
      // uncomment below and update the code to test CreateSubmissionDataRequestEventRequest
