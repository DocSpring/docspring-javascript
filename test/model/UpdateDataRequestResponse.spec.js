...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DocSpring.UpdateDataRequestResponse();
  });
  ...
  describe('UpdateDataRequestResponse', function() {
    it('should create an instance of UpdateDataRequestResponse', function() {
      ...
      //var instance = new DocSpring.UpdateDataRequestResponse();
      //expect(instance).to.be.a(DocSpring.UpdateDataRequestResponse);
    });
