...
/**
 * The SubmissionPreview model module.
 * @module model/SubmissionPreview
 * @version 3.0.0
 */
class SubmissionPreview {
    /**
     * Constructs a new <code>SubmissionPreview</code>.
     * @alias module:model/SubmissionPreview
     ...
     * @param state {module:model/SubmissionPreview.StateEnum} 
     * @param template_id {String} 
     * @param template_type {module:model/SubmissionPreview.TemplateTypeEnum} 
     ...
     */
    constructor(batch_id, data_requests, editable, expired, expires_at, id, json_schema_errors, metadata, password, processed_at, state, template_id, template_type, template_version, test, truncated_text, pdf_hash, download_url, permanent_download_url, preview_download_url, preview_generated_at, audit_trail_download_url, actions) { 
        
        SubmissionPreview.initialize(this, batch_id, data_requests, editable, expired, expires_at, id, json_schema_errors, metadata, password, processed_at, state, template_id, template_type, template_version, test, truncated_text, pdf_hash, download_url, permanent_download_url, preview_download_url, preview_generated_at, audit_trail_download_url, actions);
    }
     ...
     */
    static initialize(obj, batch_id, data_requests, editable, expired, expires_at, id, json_schema_errors, metadata, password, processed_at, state, template_id, template_type, template_version, test, truncated_text, pdf_hash, download_url, permanent_download_url, preview_download_url, preview_generated_at, audit_trail_download_url, actions) { 
    ...
    /**
     * Constructs a <code>SubmissionPreview</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SubmissionPreview} obj Optional instance to populate.
     * @return {module:model/SubmissionPreview} The populated <code>SubmissionPreview</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SubmissionPreview();
    ...
    /**
     * Validates the JSON data with respect to <code>SubmissionPreview</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SubmissionPreview</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SubmissionPreview.RequiredProperties) {
...
SubmissionPreview.RequiredProperties = ["batch_id", "data_requests", "editable", "expired", "expires_at", "id", "json_schema_errors", "metadata", "password", "processed_at", "state", "template_id", "template_type", "template_version", "test", "truncated_text", "pdf_hash", "download_url", "permanent_download_url", "preview_download_url", "preview_generated_at", "audit_trail_download_url", "actions"];

/**
 * @member {String} batch_id
 */
SubmissionPreview.prototype['batch_id'] = undefined;

/**
 * @member {Array.<module:model/SubmissionDataRequest>} data_requests
 */
SubmissionPreview.prototype['data_requests'] = undefined;

/**
 * @member {Boolean} editable
 */
SubmissionPreview.prototype['editable'] = undefined;

/**
 * @member {Boolean} expired
 */
SubmissionPreview.prototype['expired'] = undefined;

/**
 * @member {String} expires_at
 */
SubmissionPreview.prototype['expires_at'] = undefined;

/**
 * @member {String} id
 */
SubmissionPreview.prototype['id'] = undefined;

/**
 * @member {Array.<String>} json_schema_errors
 */
SubmissionPreview.prototype['json_schema_errors'] = undefined;

/**
 * @member {Object} metadata
 */
SubmissionPreview.prototype['metadata'] = undefined;

/**
 * @member {String} password
 */
SubmissionPreview.prototype['password'] = undefined;

/**
 * @member {String} processed_at
 */
SubmissionPreview.prototype['processed_at'] = undefined;

/**
 * @member {module:model/SubmissionPreview.StateEnum} state
 */
SubmissionPreview.prototype['state'] = undefined;

/**
 * @member {String} template_id
 */
SubmissionPreview.prototype['template_id'] = undefined;

/**
 * @member {module:model/SubmissionPreview.TemplateTypeEnum} template_type
 */
SubmissionPreview.prototype['template_type'] = undefined;

/**
 * @member {String} template_version
 */
SubmissionPreview.prototype['template_version'] = undefined;

/**
 * @member {Boolean} test
 */
SubmissionPreview.prototype['test'] = undefined;

/**
 * @member {Object} truncated_text
 */
SubmissionPreview.prototype['truncated_text'] = undefined;

/**
 * @member {String} pdf_hash
 */
SubmissionPreview.prototype['pdf_hash'] = undefined;

/**
 * @member {String} download_url
 */
SubmissionPreview.prototype['download_url'] = undefined;

/**
 * @member {String} permanent_download_url
 */
SubmissionPreview.prototype['permanent_download_url'] = undefined;

/**
 * @member {String} preview_download_url
 */
SubmissionPreview.prototype['preview_download_url'] = undefined;

/**
 * @member {String} preview_generated_at
 */
SubmissionPreview.prototype['preview_generated_at'] = undefined;

/**
 * @member {String} audit_trail_download_url
 */
SubmissionPreview.prototype['audit_trail_download_url'] = undefined;

/**
 * @member {Array.<module:model/SubmissionAction>} actions
 */
SubmissionPreview.prototype['actions'] = undefined;
 ...
 * @readonly
 */
SubmissionPreview['TemplateTypeEnum'] = {
