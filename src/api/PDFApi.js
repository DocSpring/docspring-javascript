...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     */
    this.addFieldsToTemplate = function(templateId, addFieldsData, callback) {
      var postBody = addFieldsData;
      ...
      var returnType = AddFieldsTemplateResponse;
     ...
     */
    this.createHTMLTemplate = function(createHtmlTemplateData, callback) {
      var postBody = createHtmlTemplateData;
     ...
     * data is of type: {@link module:model/PendingTemplate}
     */
    this.createPDFTemplateFromUpload = function(createTemplateFromUploadData, callback) {
      var postBody = createTemplateFromUploadData;
     ...
     */
    this.getFullTemplate = function(templateId, callback) {
      var postBody = null;
    ...
    this.listSubmissions = function(opts, callback) {
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ListSubmissionsResponse;
    ...
    /**
     * Callback function to receive the result of the listSubmissions_0 operation.
     * @callback module:api/PDFApi~listSubmissions_0Callback
     * @param {String} error Error message, if any.
     * @param {module:model/ListSubmissionsResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.type 
     * @param {Boolean} opts.includeData 
     * @param {module:api/PDFApi~listSubmissions_0Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ListSubmissionsResponse}
     */
    this.listSubmissions_0 = function(templateId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'templateId' is set
      if (templateId === undefined || templateId === null) {
        throw new Error("Missing the required parameter 'templateId' when calling listSubmissions_0");
      }
